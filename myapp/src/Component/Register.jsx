          ...
          <div class="p-12 bg-white mx-auto rounded-2xl w-100">
            ...
            <div class="space-y-5">
              <div class="space-y-2">
                ...
                <input class=" w-full text-base px-4 py-2 border  border-gray-300 rounded-lg focus:outline-none focus:border-green-400" type="text" placeholder="Enter Your Username"></input>
              </div>
              ...
              <div class="space-y-2">
                ...
                <input class="w-full content-center text-base px-4 py-2 border  border-gray-300 rounded-lg focus:outline-none focus:border-green-400" type="password" placeholder="Enter your password"></input>
              </div>
