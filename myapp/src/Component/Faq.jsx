...
<div className="px-4 py-20 bg-lightblue border-6 m-10 shadow-2xl rounded-lg md:m-20">
    <div className="flex flex-col max-w-6xl mx-auto md:flex-row">
        <h2 className="w-full mr-8 text-3xl font-extrabold leading-9 md:w-1/3 text-teal-700">
